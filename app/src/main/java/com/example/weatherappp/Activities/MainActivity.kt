package com.example.weatherappp.Activities
...
import com.example.weatherappp.Models.WeatherModel
import com.example.weatherappp.R
import com.example.weatherappp.Utilies.ApiUtilities
import com.example.weatherappp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="75ca088d7bde946fee60462ada41fcaa"
            ...
            if(isLocationEnabled())
            {
               if(ActivityCompat.checkSelfPermission(
                ...
                fusedLocationProvider.lastLocation
                    .addOnSuccessListener { loaction->

                        if(loaction!=null){
                            currentLocation = loaction

                            binding.progressBar.visibility =View.VISIBLE

                            fetchCurrentLocationWeather(
                                loaction.latitude.toString(),
                                loaction.longitude.toString(),
                            )
                        }
